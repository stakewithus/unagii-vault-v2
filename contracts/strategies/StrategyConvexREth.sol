...
import "../interfaces/curve/StableSwapREth.sol";
import "../StrategyEth.sol";

contract StrategyConvexREth is StrategyEth {
    ...
    address private constant FIS = 0xef3A930e1FfFFAcd2fc13434aC81bD278B0ecC8d;

    // Solc 0.7 cannot create constant arrays
    address[NUM_REWARDS] private REWARDS = [CRV, CVX, FIS];

    // Convex //
    Booster private constant BOOSTER =
        Booster(0xF403C135812408BFbE8713b5A23a04b3D48AAE31);
    // pool id
    uint private constant PID = 35;
    BaseRewardPool private constant REWARD =
        BaseRewardPool(0x61dB6c2321f784c8fAb8d5eF80f58F27C831dCc8);
    bool public shouldClaimExtras = true;

    // Curve //
    // StableSwap rEth
    StableSwapREth private constant CURVE_POOL =
        StableSwapREth(0xF9440930043eb3997fc70e1339dBb11F341de7A8);
    // LP token for curve pool (ETH / rEth)
    IERC20 private constant CURVE_LP =
        IERC20(0x53a901d48795C58f485cBB38df08FA96a24669D5);
