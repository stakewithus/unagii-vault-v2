...
import "../interfaces/curve/DepositZapMim3Crv.sol";
import "../interfaces/curve/StableSwapMim3Crv.sol";
import "../Strategy.sol";

contract StrategyConvexMim is Strategy {
    ...
    address[NUM_REWARDS] private REWARDS = [CRV, CVX, SPELL];

    // Convex //
    Booster private constant BOOSTER =
        Booster(0xF403C135812408BFbE8713b5A23a04b3D48AAE31);
    // pool id
    uint private constant PID = 40;
    BaseRewardPool private constant REWARD =
        BaseRewardPool(0xFd5AbF66b003881b88567EB9Ed9c651F14Dc4771);
    bool public shouldClaimExtras = true;

    // Curve //
    // DepositZap MIM + 3CRV
    DepositZapMim3Crv private constant ZAP =
        DepositZapMim3Crv(0xA79828DF1850E8a3A3064576f380D90aECDD3359);
    // StableSwap MIM + 3CRV (meta pool)
    StableSwapMim3Crv private constant CURVE_POOL =
        StableSwapMim3Crv(0x5a6A4D54456819380173272A5E8E9B9904BdF41B);
    ...
    */
    ...
    // @dev Claim extra rewards (SPELL) from Convex
    ...
    function _totalAssets() private view returns (uint total) {
        ...
        */
        ...
        // amount of MIM or DAI, USDC, USDT converted from Curve LP
